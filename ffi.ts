import { cstr, decode, f64ToU64, LITTLE_ENDIAN, u64ToF64 } from "./util.ts";

export const NULL_F64 = u64ToF64(0n);

//#region Sqlite3 Constants
...
const lib = Deno.dlopen("H:\\Deno\\libsqlite\\sqlite3.dll", {
  sqlite3_open_v2: {
    parameters: [
...
const libutil = Deno.dlopen("H:\\Deno\\libsqlite\\util.dll", {
  read_ptr: {
    parameters: ["f64"],
    result: "u8",
  },
